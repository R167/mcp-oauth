...
export function createMockRequest(
	...
	const { method = "GET", url = "https://test.example.com", headers = {}, body } = options;
...
export const MockFetch = {
	...
	error: (status = 400, message = "Bad Request") => vi.fn().mockResolvedValue(createMockResponse({ status, statusText: message })),
