...
export class TokenHandler {
	...
	private async handleAuthorizationCodeGrant(tokenRequest: TokenRequest): Promise<Response> {
		...
		await this.storage.storeRefreshToken(tokenId, authCode.user_id, authCode.scope, authCode.email);
	...
	private async handleRefreshTokenGrant(tokenRequest: TokenRequest): Promise<Response> {
		...
		try {
			...
			await this.storage.storeRefreshToken(newTokenId, refreshTokenPayload.sub, tokenData.scope, tokenData.email);
